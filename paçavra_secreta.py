...
vai dar a possibilidade para o usúario digitar apenas
uma letra.
...
se a letra digitada está na palavra secreta.
    ...
    - Se a letra digitada não estiver ma palavra secreta; exiba *.

Faça a contagem de tentativasdo seu usuário.
...
while True:
    ...
    print('Resposta: ', palavra_formada)
